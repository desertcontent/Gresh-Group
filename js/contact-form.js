$(document).ready(function() {
  if ($("#phone").intlTelInput) {
    $("#phone").intlTelInput({validationScript: "library/vender/intl-tel-input/js/isValidNumber.js"});
    $(".intl-tel-input.inside").css('width', '100%');
  }

  $('#feedbackForm input')
    .not('.optional,.no-asterisk')
    .after('<span class="glyphicon glyphicon-ok form-control-feedback red"></span>');
  ...
  $('#feedbackForm input').change(function () {
    var asteriskSpan = $(this).siblings('.glyphicon-ok');
    if ($(this).val()) {
